...
const shoppingCartSchema = new Schema(
  ({ ...salesManifest, ownerRef_id: { type: Schema.Types.ObjectId, ref: 'EssosUser' } }),
);
...
const sellerSpecificPurchaseOrder = new Schema(
  ({
    ...salesManifest,
    sellerRef_id: { type: Schema.Types.ObjectId, ref: 'EssosUser' },
    buyerRef_id: { type: Schema.Types.ObjectId, ref: 'EssosUser' },
    buyerName: String,
    masterPurchaseOrderRef_id: {
      type: Schema.Types.ObjectId,
      ref: 'PurchaseOrder',
    },
    customerRef_id: {
...
module.exports.ShoppingCartModel = mongoose.model(
  'ShoppingCart',
  shoppingCartSchema,
);
module.exports.MarketplaceModel = mongoose.model(
  'Marketplace',
  marketplaceSchema,
);
module.exports.StoreItemSchema = storeItemSchema;
module.exports.StoreItemModel = mongoose.model(
  'StoreItem',
  storeItemSchema,
);
module.exports.StripeCustomerModel = mongoose.model(
  'StripeCustomer',
  stripeCustomerSchema,
);
module.exports.PurchaseOrderModel = mongoose.model(
  'PurchaseOrder',
  purchaseOrderSchema,
);
module.exports.sellerSpecificPurchaseOrderModel = mongoose.model(
  'SellerShippingOrder',
  sellerSpecificPurchaseOrder,
);
