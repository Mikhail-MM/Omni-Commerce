...
const ticketSchema = new Schema({
  ...
  subTotal: { type: Number, default: 0.0 }, // subTotal is a display value which has been rounded - subtotalReal retains deep float real value
  subTotalReal: Number,
  ...
  payment: {
    ...
    metadata: {
      parentTransaction_id: { type: Schema.Types.ObjectId },
    },
    outcome: {
