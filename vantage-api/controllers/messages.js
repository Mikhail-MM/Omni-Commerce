...
module.exports.composeNewAnnouncement = async function (
  req,
  res,
  next,
) {
...
module.exports.globallyBroadcastAnnouncement = async function (
  req,
  res,
  next,
) {
  try {
    const globalAnnouncement = await Message.findOneAndUpdate(
      { _id: req.body._id },
...
module.exports.muteGlobalAnnouncement = async function (
  req,
  res,
  next,
) {
...
module.exports.getAllAnnouncementsByOrganization = async function (
  req,
  res,
  next,
) {
  try {
    const myAnnouncements = await message.find({
      isAnnouncement: true,
      mongoCollectionKey: req.body.client.mongoCollectionKey,
    });
...
module.exports.deleteMessage = async function (req, res, next) {
  try {
    const deletedMessage = await Message.findOneAndRemove({
      _id: req.body._id,
    });
