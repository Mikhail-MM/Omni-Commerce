...
const mapDispatchToProps = (dispatch) => ({
  editProfileData: (token, userID, data, imageHandler) =>
    dispatch(
      updateProfileData(token, userID, data, imageHandler, 'Omni'),
    ),
  ...
  render() {
    return (
      <div>
        <Modal
          isOpen={
            this.props.modalType === 'OMNI_EMPLOYEE_MANAGEMENT_MODAL'
          }
          style={modalStyle}
        ...
        >
          <form
            className="essos-profile-edit-form"
          ...
          >
            ...
            <div className="essos-reg-form-row">
              <div
                className="form-label-input-container"
            ...
            <div className="essos-reg-form-row">
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    this.handleChange('role', e.target.value)
                  }
                />
              </div>
            </div>
