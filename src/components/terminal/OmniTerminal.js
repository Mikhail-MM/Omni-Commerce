...
class OmniTerminal extends Component {
  ...
  calculateGross = (tickets) => {
    return `$${tickets
      .map((ticket) => ticket.subTotalReal)
                ...
                <div className="mainframe-container">
                  <div className="graph">
                    <table style={{ width: '100%' }}>
                      ...
                      <tbody>
                        {tickets &&
                          this.generateTicketStatusMappings()}
                      </tbody>
                    </table>
                  </div>
                  {tickets && (
                    <div className="row__statistics">
                      <div className="terminal-statistics-box">
                        <h5> Open Tickets </h5>
                        {tickets['Open'] && (
                          <h3> {tickets['Open'].length} </h3>
                        )}
                      </div>
                      <div className="terminal-statistics-box">
                        <h5> Voids </h5>
                        {tickets['Void'] && (
                          <h3> {tickets['Void'].length} </h3>
                        )}
                      </div>
                      <div className="terminal-statistics-box">
                        <h5> Paid Tickets </h5>
                        {tickets['Paid'] && (
                          <h3> {tickets['Paid'].length} </h3>
                        )}
                      </div>
                      <div className="terminal-statistics-box">
                        <h5> Gross Sales </h5>
