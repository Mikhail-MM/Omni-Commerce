...
class RegistrationPicker extends Component {
  ...
  handleRegistrationInitiationRequest = () => {
    if (this.state.pathway === 'Essos') {
      return this.props.showModal('AUTH_FORM_MODAL', {
        regpathEssos: true,
      });
    } else if (this.state.pathway === 'Omni') {
      return this.props.showModal('AUTH_FORM_MODAL', {
        regpathOmniMaster: true,
      });
    }
  };
      ...
      <div className="registration-picker-wrapper">
        <div className="centered-rectangle">
          ...
          <div className="picker-button-container">
            <div className="modalpicker-selector">
              <div
                ...
                className={
                  this.state.pathway === 'Essos'
                    ? 'icon-container activeIcon'
                    : 'icon-container'
                }
              >
                <img
                  alt=""
                  className="online-market-icon"
                  src="./assets/registration/online-shop.svg"
                />
              </div>
              <h3
                className={
                  this.state.pathway === 'Essos'
                    ? 'reg-selection-header activeHeader'
                    : 'reg-selection-header'
                }
              >
                {' '}
                Online Marketplace{' '}
            ...
            <div className="modalpicker-selector">
              ...
              >
                <img
                  ...
                  style={{ marginLeft: 10 }}
                  className="online-market-icon"
                  src="./assets/registration/point-of-service.svg"
                />
              </div>
              <h3
                className={
          ...
          <div className="notification-box">
            {!this.state.pathway ? null : this.state.pathway ===
              'Essos' ? (
              <h4 className="fade-in-text">
                {' '}
                Register to buy and sell goods through the Essos
                online marketplace. Build an online brand and gain
                access to a variety of products.{' '}
              </h4>
            ) : (
              <h4 className="fade-in-text">
                {' '}
                Register to use our Point-of-Sale management service
                for your retail storefront. Accept cash and card
                payments, manage employees, and gain access to
                valuable statistics and analytics.{' '}
              </h4>
            )}
          </div>
          {this.state.renderButton && (
            <button
              ...
              onClick={() =>
                this.handleRegistrationInitiationRequest()
              }
              style={{
                opacity: 0,
