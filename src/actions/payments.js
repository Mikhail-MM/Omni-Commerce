...
export function sendCashPaymentToApi(
  authToken,
  cashTendered,
  transaction_id,
) {
...
export function sendStripeTokenToApi(
  authToken,
  stripeToken,
  transaction_id,
) {
      ...
      .then((json) => {
        ...
        return fetch(`${hostURI}/payments/stripe`, {
          ...
          .then((json) => {
            ...
            console.log(json);
            dispatch(
              updateTransactionWithStripePaymentDetails(
                authToken,
                transaction_id,
                json,
              ),
...
function updateTransactionWithStripePaymentDetails(
  authToken,
  transaction_id,
  paymentJson,
) {
...
export function beginCartPaymentValidationCascade(authToken, token) {
  return (dispatch) => fetch(`${hostURI}/shoppingCart/payment/`, {
    headers: {
      'Content-Type': 'application/json',
      'x-access-token': authToken,
    },
    ...
    .then((json) => {
      console.log(
        'Returning heavy response from payment endpoints - ensure data validity',
      );
      console.log(json);
    })
    .catch((err) => console.log(err));
